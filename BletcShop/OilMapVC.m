...
- (void)viewDidLoad {
    ...
    locationArr=@[@{@"latitude":@"34.239566",@"lontitude":@"108.873341",@"shop":@"中国石化（聚家花园东北）",@"image":@"oil0.jpg",@"address":@"天台路与与天台一路交汇向北60m"},@{@"latitude":@"34.250927",@"lontitude":@"108.862463",@"shop":@"中国石化（西三环一站）",@"image":@"oil1.jpg",@"address":@"天台路与与天台一路交汇向北60m"},@{@"latitude":@"34.251389",@"lontitude":@"108.868668",@"shop":@"中国石化（红光路）",@"image":@"oil2.jpg",@"address":@"天台路与与天台一路交汇向北60m"},@{@"latitude":@"34.239566",@"lontitude":@"108.873341",@"shop":@"中国石化（宏宝加油站）",@"image":@"oil3.jpg",@"address":@"天台路与与天台一路交汇向北60m"},@{@"latitude":@"34.21073",@"lontitude":@"108.896078",@"shop":@"中国石化（恒瑞加油站）",@"image":@"oil4.jpg",@"address":@"天台路与与天台一路交汇向北60m"},@{@"latitude":@"34.265357",@"lontitude":@"108.877525",@"shop":@"中国石化（枣园西路店）",@"image":@"oil5.jpg",@"address":@"天台路与与天台一路交汇向北60m"},@{@"latitude":@"34.243865",@"lontitude":@"108.841901",@"shop":@"中国石化（枣园北路店）",@"image":@"oil6.jpg",@"address":@"天台路与与天台一路交汇向北60m"}];
